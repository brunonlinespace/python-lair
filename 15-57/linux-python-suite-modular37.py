...
class LinuxPythonLauncherEditor(QMainWindow):
    ...
    def setup_sidebar(self):
        ...
        # Use itemClicked instead of currentRowChanged to intercept selection before it visually shifts
    ...
    def on_nav_item_clicked(self, item):
        ...
        # If clicking the currently active script/dashboard, do nothing
        ...
        if self.current_script_path and self.current_script_path != "dashboard":
            if self.has_unsaved_changes(self.current_script_path):
                ...
                if response == QMessageBox.StandardButton.No:
                    # User clicked "No": Force highlight back to the actual current row completely uninterrupted
                    self.is_navigating = True
