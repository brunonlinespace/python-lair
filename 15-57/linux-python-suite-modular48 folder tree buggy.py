...
# Version: 48 (Nested Folder Tree Support)
#==============================================================================
...
class AccessibleTreeWidget(QTreeWidget):
    """Custom QTreeWidget that triggers navigation on arrow key presses."""
...
class LinuxPythonLauncherEditor(QMainWindow):
    ...
    def refresh_modules_from_disk(self):
        ...
        # Restore active selection context if possible
    ...
    def update_nav_item_indicators(self):
        # Refresh tree labels to reflect potential unsaved changes indicators
        self.populate_nav_tree()
    ...
    def setup_content_area(self):
        ...
        # Select Dashboard by default in tree
    ...
    def jump_to_module_page(self, script_path):
        ...
        # Locate corresponding tree item to select visually
