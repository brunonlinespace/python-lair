...
# Version: 57 (Subfolder Dashboard Views, Terminal Launch, Rename & Remove)
#=============================================================================
...
class LinuxPythonLauncherEditor(QMainWindow):
    ...
    def refresh_content_pages(self):
        ...
        main_dash_widget = self.create_dashboard_widget(
            title_text="<h1>Welcome to Linux Python Launcher & Editor</h1>",
            desc_text="<b>Drag and drop any Python (.py) script file directly onto this window</b> or edit files externally in the <b>modules/</b> folder, then click <b>Refresh Modules</b>.",
            filter_folder=None
        )
