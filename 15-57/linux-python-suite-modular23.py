...
class LinuxPythonLauncherEditor(QMainWindow):
    ...
    def setup_sidebar(self):
        ...
        # Refresh button placed above the Grid/List view toggle button in the sidebar
        ...
        # Add the nav_list with a stretch factor of 1 so it expands to fill available vertical space
