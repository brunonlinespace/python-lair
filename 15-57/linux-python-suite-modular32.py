...
class LinuxPythonLauncherEditor(QMainWindow):
    ...
    def setup_sidebar(self):
        ...
        # Grid/List View button comes first, Refresh Modules comes second
    ...
    def refresh_content_pages(self):
        ...
        if not self.modules:
            ...
            if self.dashboard_mode == "list":
                ...
                for mod in sorted_dashboard_mods:
                    ...
                    # Dashboard buttons without icons for Terminal, Edit, and Remove
        ...
        for mod in sorted_mods_all:
            ...
            # Terminal, Rename, and Make Executable buttons without icons
