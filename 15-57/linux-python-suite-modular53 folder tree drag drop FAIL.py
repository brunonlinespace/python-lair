...
# Version: 53 (Safeguarded Drag & Drop Re-parenting Pointer Handling)
#=============================================================================
...
class AccessibleTreeWidget(QTreeWidget):
    ...
    def dropEvent(self, event: QDropEvent):
        # Capture the dragged item and its script path safely BEFORE calling super().dropEvent(),
        # protecting against dangling pointers or internal node deletions during the model change.
