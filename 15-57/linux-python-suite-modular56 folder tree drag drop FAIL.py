...
# Version: 56 (Safeguarded Drag & Drop Re-parenting Pointer Handling Fix)
#=============================================================================
        ...
        if dragged_item:
            ...
            if target_item:
                ...
                if target_data == "dashboard":
                    ...
                    # Reconstruct folder name path safely from tree hierarchy
                    path_parts = []
                    curr = target_item
            ...
            if target_rel_dir == "." or not target_rel_dir or target_rel_dir.startswith(".."):
                target_rel_dir = ""
