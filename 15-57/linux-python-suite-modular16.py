...
class LinuxPythonEditorLauncher(QMainWindow):
    ...
    def refresh_content_pages(self):
        ...
        if not self.modules:
            ...
            if self.dashboard_mode == "list":
                ...
                for index, mod in enumerate(self.modules, start=1):
                    ...
                    launch_btn = QPushButton("▶ Background")
        ...
        for index, mod in enumerate(self.modules, start=1):
            ...
            action_btn = QPushButton("▶ Run Background")
            ...
            term_action_btn = QPushButton("🖥 Launch in Terminal")
            ...
            header_layout.addWidget(term_action_btn)
    ...
    def launch_in_terminal(self, script_path):
        ...
        # Candidate terminals in typical Linux environments
        terminals = [
