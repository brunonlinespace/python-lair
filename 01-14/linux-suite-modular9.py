...
# -*- coding: utf-8 -*-
#
# Dynamic Linux Productivity Suite Launcher with Manual & Auto-Refresh Integration
...
class DynamicProductivitySuite(QMainWindow):
    ...
    def refresh_modules_from_disk(self):
        """Scans the disk for external modifications/additions/deletions in the modules folder."""
        ...
        # Keep selection safe within valid boundaries
    ...
    def refresh_content_pages(self):
        ...
        dash_layout.addWidget(QLabel("<b>Drag and drop any Python (.py) script file directly onto this window</b> or edit files externally in the <b>modules/</b> folder, then click <b>Refresh Modules</b>."))
