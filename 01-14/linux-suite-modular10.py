...
# -*- coding: utf-8 -*-
#
# Dynamic Linux Productivity Suite Launcher with Scrollable Dashboard Layout
...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QLabel, QStackedWidget, QFrame, QListWidget, QMessageBox, QTextEdit, QScrollArea
)
...
class DynamicProductivitySuite(QMainWindow):
    ...
    def refresh_content_pages(self):
        ...
        # Page 0: Dynamic Dashboard Home wrapped in a QScrollArea for responsiveness
