...
# -*- coding: utf-8 -*-
#
# Dynamic Linux Productivity Suite Launcher with List/Grid Mode Switcher & State Memory
...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QLabel, QStackedWidget, QFrame, QListWidget, QMessageBox, QTextEdit, QScrollArea, QGridLayout
)
...
class DynamicProductivitySuite(QMainWindow):
    def __init__(self):
        ...
        # Load last used dashboard mode ("list" or "grid"), defaulting to "list"
    ...
    def toggle_dashboard_mode(self):
        """Switches between list and grid views and remembers the state."""
    ...
    def refresh_content_pages(self):
        ...
        # Page 0: Dynamic Dashboard Home wrapped in a QScrollArea
        ...
        # Header layout with title and mode toggle button
        ...
        if not self.modules:
            ...
            if self.dashboard_mode == "list":
                ...
                for index, mod in enumerate(self.modules, start=1):
                    ...
                    row = (index - 1) // 3
                    col = (index - 1) % 3
                    self.grid_layout.addWidget(card_frame, row, col)

                dash_layout.addLayout(self.grid_layout)
