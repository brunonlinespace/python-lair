...
# Version: 79 (Native Styling & Nest Updates)
# ==============================================================================
...
class LinuxPythonLauncherEditor(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Python Lair (v79) - Simple Launcher & Editor")
        ...
        if self.current_script_path in self.title_labels:
            ...
            if mod_info:
                ...
                if self.has_unsaved_changes(self.current_script_path):
                    title_lbl.setText(f"<h2>{mod['name']} [Unsaved Modifications]</h2><font color='#858585'>{mod_info['path']}</font>")
                else:
    ...
    def refresh_content_pages(self):
        ...
        desc_label = QLabel("Welcome! Drag and drop any Python (.py) script file directly onto this window or edit files externally in the <b>my nest/</b> folder[cite: 1], then click <b>Refresh Scripts</b>.")
