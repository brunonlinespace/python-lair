...
class LinuxPythonLauncherEditor(QMainWindow):
    ...
    def refresh_content_pages(self):
        ...
        main_dash_widget = self.create_dashboard_widget(
            ...
            desc_text="Welcome! <b>Drag and drop any Python (.py) script file directly onto this window</b> or edit files externally in the <b>modules/</b> folder, then click <b>Refresh Modules</b>.",
            filter_folder=None
        )
