...
# Version: 72 (Clear Search Action Added)
# ==============================================================================
...
class LinuxPythonLauncherEditor(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Python Lair (v72) - Simple Launcher & Editor")
    ...
    def refresh_content_pages(self):
        ...
        # Clear search action (X icon button inside the search field)
        clear_action = QAction("✖", self.search_input)
        clear_action.setToolTip("Clear search")
        clear_action.triggered.connect(self.clear_search_filter)
