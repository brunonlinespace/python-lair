...
# Version: 74 (Embedded Editor Find Feature & Search Clear Added)
# ==============================================================================
    ...
    def refresh_content_pages(self):
        ...
        self.search_input.setStyleSheet("""
            QLineEdit {
                ...
                border-radius: 4px; padding: 8px; padding-right: 55px; font-size: 10pt;
            }
            QLineEdit:focus {
                border-color: #007acc;
            }
        ...
        # Clear action (✕) inside the search box
        self.clear_action = QAction("✕", self.search_input)
        self.clear_action.setToolTip("Clear search")
        self.clear_action.triggered.connect(self.clear_search_box)
        self.search_input.addAction(self.clear_action, QLineEdit.ActionPosition.TrailingPosition)
        ...
        self.clear_action.setVisible(bool(self.search_input.text()))
        self.search_input.textChanged.connect(lambda text: self.clear_action.setVisible(bool(text)))
