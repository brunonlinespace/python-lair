...
# Version: 77 (Search & Clear Buttons Reordered Layout Update)
# ==============================================================================
...
class LinuxPythonLauncherEditor(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Python Lair (v77) - Simple Launcher & Editor")
    ...
    def refresh_content_pages(self):
        ...
        # Row 2: Search and Clear buttons positioned underneath the search bar
        ...
        action_buttons_layout.addWidget(search_btn)
        ...
        action_buttons_layout.addWidget(clear_search_btn)
        
        action_buttons_layout.addStretch()
        dash_layout.addLayout(action_buttons_layout)

        # Row 3: Sort controls positioned underneath search/clear action buttons
