...
# Version: 76 (Instant Live Search & Fast Clear Update)
# ==============================================================================
...
class LinuxPythonLauncherEditor(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Python Lair (v76) - Simple Launcher & Editor")
    ...
    def refresh_content_pages(self):
        ...
        # Row 1: Search bar with instant live filtering and permanent Clear button
        ...
        """)
        # Connect textChanged signal for instant live searching as you type
        ...
        # Row 2: Sort controls positioned directly UNDER the search bar
        ...
        dash_layout.addLayout(sort_layout)
    ...
    def on_search_text_changed(self, text):
        self.search_filter_text = text
        current_cursor_pos = self.search_input.cursorPosition() if hasattr(self, 'search_input') else 0
        self.refresh_content_pages()
        if hasattr(self, 'search_input') and not self.search_input.hasFocus():
