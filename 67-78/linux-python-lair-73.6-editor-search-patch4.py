...
class LinuxPythonLauncherEditor(QMainWindow):
    ...
    def find_text_in_editor(self, editor, search_input):
        ...
        # If not found, or if we are already at the end/selection boundary, wrap to start
        if found_cursor.isNull() or found_cursor == cursor:
        ...
        # Final safety check: if still null, display message instead of crashing
